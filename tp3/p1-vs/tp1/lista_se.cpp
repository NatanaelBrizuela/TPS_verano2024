...
void Lista_se::insertar_lista(Dato dat, unsigned indice)
{
...
Dato Lista_se::obtener_dato_lista(const unsigned indice)
{
    Nodo* punt_aux = obtener_nodo(indice);
    return punt_aux->obtener_dato();
}

void Lista_se::eleimnar_dato_lista(const unsigned indice)
{
...
unsigned Lista_se::obtener_tamaño()
{
    return tamaño;
}

/**/
Nodo* Lista_se::obtener_nodo(const unsigned indice)
{
